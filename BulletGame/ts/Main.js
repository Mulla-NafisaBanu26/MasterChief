...
var Main = (function () {
    function Main(canvas) {
        ...
        this.manifest =
            [
                ...
                { src: 'assets/images/cropped-helicopter-sunset2.jpg', id: 'background' },
        ...
        this.queue.on('progress', function (e) { _this.loading(e); });
        this.queue.loadManifest(this.manifest);
    }
    Main.prototype.loading = function (e) {
        var result = 'WELCOME TO BULLET WAR \n ';
        result = result + " Please read instruction carefully before playing. \n";
        result = result + " Press space bar key : bullet. \n";
        result = result + " Right arrow key : sprite will move to right. \n";
        result = result + " Down arrow key : sprite will knee down. \n";
        result = result + " If both person collide then game will get over \n";
    ...
    Main.prototype.onComplete = function (e) {
        ...
        createjs.Ticker.on('tick', function (e) { _this.tick(e); });
        ...
        this.asukaInterval = setInterval(function () { _this.createAsuka(); }, 6000);
    };
